...
<!-- xmlspec.xsl: An HTML XSL[1] Stylesheet for XML Spec V2.1[2] markup
     ...
     Version: $Id: basespec.xsl,v 1.2 2013-10-02 14:34:04 NormanWalsh Exp $
     ...
     Date:    Created 07 September 1999
              Last updated $Date: 2013-10-02 14:34:04 $ by $Author: NormanWalsh $
...
<!--
  ...
  <xsl:template match="notice">
    <div>
      <xsl:attribute name="class">
        <xsl:choose>
          <xsl:when test="@role='draft'">draft-notice</xsl:when>
...
<!--
  ...
  <!-- mode="toc" templates are defined in diffspec.xsl. -->
...
div.draft-notice     { margin-left: 2em; margin-right: 2em; background-color: #FFC0FF; }
